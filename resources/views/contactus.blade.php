...
<section class="wrapper">
    ...
    <div class="row mt">
        <div class="col-lg-6 col-md-6 col-sm-6">
            <div id="message"></div>
            <form class="contact-form php-mail-form" role="form" action="{{url('contactus/sent')}}" method="POST">
                @csrf
                ...
                <div class="form-group">
                    <input type="tel" name="phone" pattern="0[0-9]{2}[0-9]{2}[0-9]{2}[0-9]{2}" class=" form-control"
                        value id="contact-phone" placeholder="Your Phone Number" data-rule="phone"
                        data-msg="Please enter a valid email">
                    <div class="validate"></div>
                </div>
                <div class="form-group">
                    <input type="text" name="adresse" class="form-control" id="contact-subject" placeholder="Adresse"
                ...
                <div class="form-group">
                    <textarea class="form-control" name="description" id="contact-description" placeholder="Description"
